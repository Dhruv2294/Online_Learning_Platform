...
const Dashboard = () => {
    ...
    const [activities] = useState([
        { id: 1, message: 'Completed the course: React JS', date: '2024-10-18' },
        { id: 2, message: 'Started the course: HTML Basics', date: '2024-10-15' },
        { id: 3, message: 'Watched: CSS for Beginners', date: '2024-10-14' },
    ]);

    const [upcomingTasks] = useState([
        { id: 1, title: 'Finish project for HTML Basics', dueDate: '2024-10-20' },
        { id: 2, title: 'Watch the next lecture on React Js', dueDate: '2024-10-21' },
    ]);

    // New courses data
    const [newCourses] = useState([
        { id: 1, title: 'Web Development Bootcamp', description: 'Learn full-stack web development from scratch.', duration: '2 months' },
        { id: 2, title: 'Data Science with Python', description: 'Dive into data analysis and machine learning.', duration: '1 months' },
        { id: 3, title: 'Digital Marketing Masterclass', description: 'Understand the ins and outs of digital marketing.', duration: '1 months' },
    ]);
                ...
                <ul >
                    {newCourses.map((course) => (
                        <li key={course.id} className="course-item">
                            ...
                            <button style={{backgroundColor:"white"}} className="enroll-button" onClick={() => handleEnroll(course.title)}>Enroll Now</button>
                        </li>
                    ))}
                </ul>
            </div>
